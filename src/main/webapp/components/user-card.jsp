...
<div id="post" class="card p-2 mb-3">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a class="btn btn-secondary d-flex align-items-center gap-2" href="${pageContext.request.contextPath}/ControllerServlet?action=sendFriendRequest&userReceivedId=${param.userId}">
